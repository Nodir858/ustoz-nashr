...
export default function ProductPage() {
  ...
  const {addToCart, removeFromCart,updateQuantity, totalAmount, totalItems } = useCart();
...
// console.log("cart" + cart)
  return (
    <div className='bg-sky-100 h-screen'>
      <div className="flex flex-col md:flex-row p-5 m-auto max-w-[70rem] gap-5">
        <div>

        <img
          src={products.img}
          alt={products.title}
          className="rounded-xl w-200 object-contain"
        />
        </div>
